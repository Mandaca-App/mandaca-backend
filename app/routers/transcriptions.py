...
async def transcribe_audio(
    ...
    """Transcreve um arquivo de áudio e retorna apenas o texto — sem persistência no BD. Usado pelo chatbot para converter a mensagem de voz do usuário em texto"""
